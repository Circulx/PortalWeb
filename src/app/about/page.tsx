  ...
  const values = [
    {
      ...
      description: "We believe that trust i s the currency  of commerce.We operate with complete transparency, from our verification process to our fee structure."
    },
    {
