          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-wrap gap-3 pt-4">
              ...
              <Button 
                size="lg" 
                variant="outline" 
                className="rounded-full px-8 py-6 text-base font-semibold border-2 border-gray-300"
          ...
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <div className="mt-8 md:mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-white p-6 rounded-xl border border-gray-200 hover:shadow-lg transition-shadow">
                ...
                <a href="https://www.youtube.com/watch?v=Vj2Q_11tol0" target="_blank" rel="noopener noreferrer" className="text-green-600 font-semibold hover:text-green-700 text-sm">
                  Watch Video →
                </a>
              </div>
              ...
              <div className="bg-white p-6 rounded-xl border border-gray-200 hover:shadow-lg transition-shadow">
                ...
                <a href="#" target="_blank" rel="noopener noreferrer" className="text-green-600 font-semibold hover:text-green-700 text-sm">
                  Watch Video →
                </a>
              </div>
        ...
        <section className="py-12 md:py-16">
          <div className="container mx-auto px-4 max-w-6xl">
            <div className="text-center mb-8 md:mb-12">
              ...
              <p className="text-gray-600 text-lg">
                Find quick answers to common questions about your seller account
              </p>
            </div>
                  ...
                  <div className="bg-white rounded-2xl p-6 border border-green-200 shadow-lg">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <a href="mailto:product.circ@i10ai.com" className="text-green-600 font-semibold text-sm hover:text-green-700 break-all">
